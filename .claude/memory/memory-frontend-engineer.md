...
**MANDATORY**: Before ANY frontend implementation or debugging:
1. Identify technology/domain (React, TypeScript, Tailwind, etc.)
...
- **Stack**: [To be configured - likely React + TypeScript + Vite + Tailwind]
...
- Awaiting frontend requirements
