...
**Skill invocation** (from agent instructions):
- `Skill(skill="deployment-cloud-run")` - Cloud Run service configs
- `Skill(skill="deployment-cloud-build")` - CI/CD pipeline patterns
- `Skill(skill="deployment-terraform")` - Infrastructure as Code
- `Skill(skill="deployment-oauth")` - OAuth deployment patterns
- `Skill(skill="deployment-validation")` - Pre/post deployment validation
- `Skill(skill="deployment-troubleshooting")` - Common errors & fixes
